		...
		resources: {
			en: {
				translation: {
					...
					spoilers: "Mind the spoilers when posting!",
				},
			},
			es: {
				translation: {
					...
					spoilers: "¡Avisa de los spoilers al subir!",
				},
			},
			ja: {
				translation: {
					...
					custom: "カスタム",
					"enter-a-value": "値を入力",
					"enter-a-value-error": "有効な数値を入力してください... *honk*", // honk is a sound effect
					"delete-layer-warn":
						"これは唯一のレイヤーであり、削除できません。代わりに「非表示」オプションを使用してください。",
					"clear-warn":
						"キャンバスをクリアしようとしています！ 進捗状況が失われます。\n「OK」を押すと操作が実行されます。",
					layer: "レイヤー",
					spoilers: "投稿する前にネタバレに注意してください！",
			...
			zh_tw: {
				translation: {
					...
					"font-offset": "字體偏移",
					"font-offset-info": "如果畫布中的文字未對齊，可能需要進行調整。",
					"font-shadow": "字體陰影",
					"sprites-header": "立繪",
					...
					"delete-layer-warn": "這是唯一的圖層，無法刪除。請使用“隱藏”選項。",
					"clear-warn":
						"您即將清除畫布！任何進度都將丟失。\n按下“確定”將執行此操作。",
					layer: "圖層",
					spoilers: "發文前請注意劇透！",
			...
			zh_cn: {
				translation: {
					...
					"font-offset": "字体偏移",
					"font-offset-info": "如果画布中的文字未对齐，可能需要进行调整。",
					"font-shadow": "字体阴影",
					"sprites-header": "立绘",
					...
					"delete-layer-warn": "这是唯一的图层，无法删除。请使用“隐藏”选项。",
					"clear-warn":
						"您即将清除画布！任何进度都将丢失。\n按下“确定”将执行此操作。",
					layer: "图层",
					"report-issue": "報告問題",
